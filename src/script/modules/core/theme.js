...
'8d20a0be-25e2-48e4-a4c1-9ec8fa809cab':
{
	...
	options: {
		...
		borderColorHighlight: { title: '高亮邊框顏色', type: 'text', defaultValue: 'e9ec6c', access: 'public' },
		bgColorHighlight: { title: '高亮背景顏色', type: 'text', defaultValue: 'e9ec6c', access: 'public' },
		fcHighlight: { title: '高亮文字顏色', type: 'text', defaultValue: '000000', access: 'public' },
	...
	tasks: {
		'd15b72b1': {
			...
			js: function(job, options)
			{
				$.rules({ id: 'main-style' }, '\
					...
					\
					.ui-state-default, .ui-widget-content .ui-state-default, .ui-widget-header .ui-state-default { border-color: #{0[borderColorDefault]}; background: #{0[bgColorDefault]}; color: #{0[fcDefault]}; } \
					...
					\
					.ui-corner-tl { border-top-left-radius: {0[cornerRadius]}; } \
					.ui-corner-tr { border-top-right-radius: {0[cornerRadius]}; } \
					.ui-corner-bl { border-bottom-left-radius: {0[cornerRadius]}; } \
					.ui-corner-br { border-bottom-right-radius: {0[cornerRadius]}; } \
					.ui-corner-top { border-top-left-radius: {0[cornerRadius]}; border-top-right-radius: {0[cornerRadius]}; } \
					.ui-corner-bottom { border-bottom-left-radius: {0[cornerRadius]}; border-bottom-right-radius: {0[cornerRadius]}; } \
					.ui-corner-right {  border-top-right-radius: {0[cornerRadius]};border-bottom-right-radius: {0[cornerRadius]}; } \
					.ui-corner-left { border-top-left-radius: {0[cornerRadius]}; border-bottom-left-radius: {0[cornerRadius]}; } \
					.ui-corner-all { border-radius: {0[cornerRadius]}; } \
					\
		...
		'475b4b70': {
			...
			js: function(job)
			{
				job.hooks('theme', null, job.options());
			}
		}
	}
}
